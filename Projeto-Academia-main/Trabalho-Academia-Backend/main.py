...
from app.api.routes.academias_routes  import academias
from app.api.routes.personais_routes  import personais
...
app.include_router(academias)
app.include_router(personais)
