...
class PersonalVinculoCreate(BaseModel):
    academia_id: int
...
class PersonalVinculoUpdate(BaseModel):
    dias_semana: Optional[str] = None
    horario_inicio: Optional[str] = None
    horario_fim: Optional[str] = None
...
class PersonalAcademiaRead(BaseModel):
    id: int
    academia: AcademiaRead
    dias_semana: Optional[str] = None
    horario_inicio: Optional[str] = None
    horario_fim: Optional[str] = None
...
class PersonalRead(BaseModel):
    ...
    especialidade: Optional[str] = None
    bio: Optional[str] = None
    academias: List[PersonalAcademiaRead]


class VinculoAlunoPersonal(BaseModel):
