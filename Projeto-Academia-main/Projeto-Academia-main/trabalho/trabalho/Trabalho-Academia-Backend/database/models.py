...
# ─────────────────────────────────────────────
# CATÁLOGO: populado via API pública (wger)
# ─────────────────────────────────────────────
class ExercicioCatalogo(Base):
    """
    Exercícios importados da API pública wger (https://wger.de/api/v2/).
    O personal não cria esses registros — eles vêm do script de importação.
    """
...
# ─────────────────────────────────────────────
# TREINO: agrupamento criado pelo personal
# ─────────────────────────────────────────────
class Treino(Base):
...
# ─────────────────────────────────────────────
# TABELA DE JUNÇÃO: Treino ↔ ExercicioCatalogo
# Aqui ficam os parâmetros de execução (séries, reps, carga)
# ─────────────────────────────────────────────
class TreinoExercicio(Base):
    """
    Liga um exercício do catálogo a um treino específico,
    adicionando os parâmetros definidos pelo personal (séries, reps, carga).
    """
